...
test("merge", assert => {
  ...
  assert.equals(obj.bool, false, "False Summation");
  assert.equals(obj.undef, void 0, "Undefined Summation");
  assert.equals(obj.null, null, "Null Summation");
  assert.equals(obj.missing, 42, "Missing Summation");
  assert.end();
